% Exercise 4.e Monte Carlo simulation
clear all;
close all;
clc;
p0 = 0.65; % true probability of getting head when tossing the biased coin
n = [100 1000 10000]; % matrix of sample size
rep = 10000; % number of repeated experiments with n-sample
bins = 50;
for i = 1:1:length(n)
    f = rand(n(i),rep); % generate a matrix of uniform distributed number between 0
